...
export default function HomeHeader() {
  return (
    <header className="relative z-10 flex shrink-0 items-center px-[calc(var(--frame)_+_2rem)] pt-[calc(var(--frame)_+_1rem)] max-sm:px-[calc(var(--frame)_+_0.75rem)] max-sm:pt-[calc(var(--frame)_+_0.6rem_+_var(--safe-top))]">
      <div className="flex min-w-0 items-center gap-[clamp(0.9rem,1.3vw,1.5rem)] max-sm:gap-2.5" data-testid="kiosk-brand">
        ...
        <span
          aria-hidden
          className="h-[clamp(2.8rem,4.2vw,4.6rem)] w-[3px] shrink-0 rounded-full bg-gradient-to-b from-transparent via-[var(--p-gold)] to-transparent max-sm:h-9 max-sm:w-[2px]"
        />
        <p
          lang="az"
          className="shrink-0 whitespace-nowrap font-display text-[clamp(2.1rem,3vw,3.4rem)] font-bold uppercase leading-none tracking-[0.07em] text-[var(--p-burgundy)] max-sm:text-[1.4rem] max-sm:tracking-[0.05em]"
