    ...
    <svg viewBox="0 0 240 240" className={className} aria-hidden="true" data-testid="quiz-emblem">
      <defs>
        <radialGradient id={`${id}-glow`}>
          <stop offset="0" stopColor="#e8d29c" stopOpacity="0.32" />
          <stop offset="1" stopColor="#e8d29c" stopOpacity="0" />
        </radialGradient>
        ...
        <radialGradient id={`${id}-core`} cx="0.38" cy="0.32" r="0.8">
          <stop offset="0" stopColor="#93404c" />
          <stop offset="0.6" stopColor="#6b2230" />
          <stop offset="1" stopColor="#3a1620" />
        </radialGradient>
      </defs>
      <circle cx="120" cy="120" r="119" fill={`url(#${id}-glow)`} />
      <circle cx="120" cy="120" r="108" fill="none" stroke="#d9bb7c" strokeOpacity="0.45" strokeWidth="1.5" strokeDasharray="2 7" />
      <polygon points={starPoints(120, 120, 100)} fill={`url(#${id}-gold)`} stroke="#5e4424" strokeWidth="2" strokeLinejoin="round" />
      <polygon points={starPoints(120, 120, 84)} fill="none" stroke="#f6ead0" strokeOpacity="0.65" strokeWidth="1.5" strokeLinejoin="round" />
      <circle cx="120" cy="120" r="58" fill={`url(#${id}-core)`} stroke="#e8d29c" strokeWidth="4" />
      <circle cx="120" cy="120" r="48" fill="none" stroke="#e8d29c" strokeOpacity="0.45" strokeWidth="1.2" />
      <path
...
export function RewardMedal({ className = '' }: { className?: string }) {
  ...
  return (
    <svg viewBox="0 0 64 86" className={className} aria-hidden="true">
      ...
      <path d="M20 44 L11 82 L23 75 L30 85 L35 48 Z" fill="#6b2230" />
      <path d="M44 44 L53 82 L41 75 L34 85 L29 48 Z" fill="#7e2e3a" />
      <polygon points={starPoints(32, 32, 30)} fill={`url(#${id}-gold)`} stroke="#5e4424" strokeWidth="1.2" strokeLinejoin="round" />
      <circle cx="32" cy="32" r="14" fill="#fbf6ec" stroke="#b8955a" strokeWidth="2" />
      <polygon points={starPoints(32, 32, 8.5)} fill="#6b2230" />
    </svg>
  )
}
...
export function RuleBadge({ className = '' }: { className?: string }) {
  ...
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden="true">
      ...
      <polygon points={starPoints(32, 32, 30)} fill={`url(#${id}-gold)`} stroke="#5e4424" strokeWidth="1.2" strokeLinejoin="round" />
      <circle cx="32" cy="32" r="17" fill="#6b2230" stroke="#e8d29c" strokeWidth="2" />
...
export function VictoryStar({ className = '' }: { className?: string }) {
  ...
  return (
    <svg viewBox="0 0 120 120" className={className} aria-hidden="true" data-testid="victory-star">
      <defs>
        <radialGradient id={`${id}-glow`}>
          <stop offset="0" stopColor="#e8d29c" stopOpacity="0.35" />
          <stop offset="1" stopColor="#e8d29c" stopOpacity="0" />
        </radialGradient>
        <linearGradient id={`${id}-gold`} x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#f1dfae" />
      ...
      <polygon points={starPoints(60, 60, 50)} fill={`url(#${id}-gold)`} stroke="#5e4424" strokeWidth="1.5" strokeLinejoin="round" />
      <circle cx="60" cy="60" r="28" fill="#6b2230" stroke="#e8d29c" strokeWidth="2.5" />
...
export function OpenBookMark({ className = '' }: { className?: string }) {
  return (
    <svg viewBox="0 0 120 80" className={className} aria-hidden="true" fill="none" stroke="#e8d29c" strokeWidth="3" strokeLinejoin="round" strokeLinecap="round">
      ...
      <path d="M20 26 C32 24 44 25 52 30 M20 38 C32 36 44 37 52 42 M20 50 C32 48 44 49 52 54" stroke="#b8955a" strokeWidth="2.4" />
      <path d="M68 30 C76 25 88 24 100 26 M68 42 C76 37 88 36 100 38 M68 54 C76 49 88 48 100 50" stroke="#b8955a" strokeWidth="2.4" />
    </svg>
  )
}
...
export function HourglassMark({ className = '' }: { className?: string }) {
  ...
  return (
    <svg viewBox="0 0 120 120" className={className} aria-hidden="true">
      ...
      <polygon points={starPoints(60, 60, 56)} fill={`url(#${id}-gold)`} stroke="#5e4424" strokeWidth="1.5" strokeLinejoin="round" />
      <circle cx="60" cy="60" r="36" fill="#0f1730" stroke="#e8d29c" strokeWidth="2.5" />
      <path d="M46 38 H74 M46 82 H74" stroke="#e8d29c" strokeWidth="4" strokeLinecap="round" />
      ...
      <path d="M53 78 C55 71 60 69 60 69 C60 69 65 71 67 78 Z" fill="#e8d29c" />
    </svg>
  )
}
