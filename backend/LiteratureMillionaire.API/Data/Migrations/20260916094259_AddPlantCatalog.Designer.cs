...
namespace LiteratureMillionaire.API.Data.Migrations
{
    ...
    [Migration("20260916094259_AddPlantCatalog")]
    partial class AddPlantCatalog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiteratureMillionaire.API.Entities.Plant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("BotanicalNote")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.HasIndex("QuizStatus");

                    b.ToTable("Plants", (string)null);
                });

            modelBuilder.Entity("LiteratureMillionaire.API.Entities.PlantImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("SpecimenSpecies")
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");
                    ...
                    b.HasIndex("PlantId", "DisplayOrder");
            ...
            modelBuilder.Entity("LiteratureMillionaire.API.Entities.PlantImage", b =>
                {
                    b.HasOne("LiteratureMillionaire.API.Entities.Plant", "Plant")
                        .WithMany("Images")
