...
{
    /// <summary>Builds a new campaign quiz (QuizRules.QuestionsPerQuiz questions from the requested or default campaign's quiz mode) and returns its first question.</summary>
